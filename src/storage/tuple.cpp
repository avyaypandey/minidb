...
namespace minidb {
     ...
     */
    const Field::Value& Field::GetValue() const
    {
        return value_;
    }
     ...
     */
    void Tuple::AddInteger(int32_t value)
    {
     ...
     */
    void Tuple::AddString(const std::string& value)
    {
        fields_.emplace_back(value);
    }
     ...
     */
    const std::vector<Field>& Tuple::Fields() const
    {
        return fields_;
    }
